 ...
 * Objective:
 *
 * Context: You will be given a 2D matrix of size N*M which will contain only dot(.) and minus(-) where dot(.) means you can go in that cell and minus(-) means you can't.
