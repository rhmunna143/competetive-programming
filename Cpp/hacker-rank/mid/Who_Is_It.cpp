...
int main()
{
    ...
    for (int i = 0; i < T; i++)
    {
        ...
        for (int j = 0; j < 3; j++)
        {
            if (students[j].total_marks > maximum_marks)
            {
                maximum_marks = students[j].total_marks;
                maximum_id = j;
            }
            else if (students[j].total_marks == maximum_marks)
            {
                if (students[j].id < students[maximum_id].id)
                {
                    maximum_id = j;
                }
            }
        ...
        cout << students[maximum_id].id << " " << students[maximum_id].name << " " << students[maximum_id].section << " " << students[maximum_id].total_marks << endl;
    }
